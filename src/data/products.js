...
export const cupcakes = [
  ...
  { id: 'cp9', name: 'LEMON CURD CUPCAKE', price: '₹50', image: LOCAL('vanilla-cupcake.jpeg'), desc: 'Tangy lemon curd topped cupcake — per piece' },
]
...
export const brownies = [
  ...
  { id: 'b2', name: 'CARAMEL CORNFLAKE BROWNIE (BOX OF 6)', price: '₹700', image: LOCAL('brownies.jpeg'), desc: 'Crunchy cornflake topping with caramel drizzle' },
  { id: 'b3', name: 'BROWNIE GIFT BOX', price: '₹1,000', image: LOCAL('brownies.jpeg'), desc: 'Assorted brownies in a beautiful gift box' },
]
...
const extraDesserts = [
  ...
  { id: 'd12', name: 'NEW YORK CHEESECAKE', price: '₹150', image: LOCAL('blueberry-cheesecake.jpeg'), desc: 'Classic creamy New York-style cheesecake — per slice' },
  { id: 'd13', name: 'BURNT BASQUE CHEESECAKE', price: '₹180', image: LOCAL('blueberry-cheesecake.jpeg'), desc: 'Caramelised Basque-style cheesecake with creamy centre — per slice' },
  { id: 'd14', name: 'CARAMEL CUSTARD', price: '₹80', image: LOCAL('brownies.jpeg'), desc: 'Silky caramel custard dessert — per piece' },
  { id: 'd15', name: 'CHOCOLATE WITH WHIPPED CARAMEL', price: '₹180', image: LOCAL('chocolate-cake.jpeg'), desc: 'Rich chocolate dessert topped with whipped caramel — per piece' },
  ...
  { id: 'd21', name: 'BANANA & CHOCOLATE MUFFIN', price: '₹60', image: LOCAL('banana-bread.jpeg'), desc: 'Moist banana muffin with dark chocolate chunks — per piece' },
  ...
  { id: 'd24', name: 'HUMMINGBIRD CAKE SLICES', price: '₹50', image: LOCAL('raspberry-ripple.jpeg'), desc: 'Pineapple, banana, and pecan cake with cream cheese frosting — per slice' },
