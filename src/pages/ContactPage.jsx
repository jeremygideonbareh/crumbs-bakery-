...
export default function ContactPage() {
  ...
  const { data: hero } = usePageSection('contact_hero', {
    subtitle: 'Get in Touch',
    title: "We'd love to hear from you",
    body: "Whether it's a custom cake order, a catering enquiry, or just to say hello — drop us a message and we'll get back to you within an hour.",
  })

  const { data: infoCards } = usePageSection('contact_info', [
    { label: 'Location', value: 'Jaiaw Chapel Rd, opposite Jaiaw Presbyterian, Shillong, Meghalaya 793002', href: 'https://maps.google.com/?q=Crumbs+Bakery+%26+Cafe+Shillong' },
    { label: 'Phone', value: '096127 72089', href: 'tel:+919612772089' },
    { label: 'Email', value: 'hello@crumbs.in', href: 'mailto:hello@crumbs.in' },
    { label: 'Hours', value: 'Mon–Sat: 8:00 AM – 9:30 PM\nSun: 10:00 AM – 6:00 PM' },
  ])

  const { data: mapData } = usePageSection('contact_map', {
    iframe_url: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3597.079772766145!2d91.8766284!3d25.5855879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37507f89317d134b%3A0xfb2b38342e332fbf!2sCrumbs%20Bakery%20%26%20Cafe!5e0!3m2!1sen!2sin!4v1',
  })

  const { data: faqs } = usePageSection('contact_faq', [
  ...
  const infoList = Array.isArray(infoCards) ? infoCards : []
